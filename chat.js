...
function like() {
    let thankYouMessage = "Thank you for addressing my query.";
    let userHtml = '<p class="userText"><span>' + thankYouMessage + '</span></p>';
    $("#chatbox").append(userHtml);
    document.getElementById("chat-bar-bottom").scrollIntoView(true);
}   
...
function getBotResponse(input) {
    ...
    } else if (lowerInput === "goodbye") {
        return "Talk to you later!";
    } else {
        return "I'm sorry, I didn't understand that. Please ask about admissions or type a number for more information.";
    }
}



// SEND AND HEART BUTTON
function sendButton() {
    getResponse();
}
